...
# linear_submission.to_csv('F:/demo/kaggle/mnist/linear_submission.csv',index=False)
#
...
# dnn_submission.to_csv('F:/demo/kaggle/mnist/dnn_submission.csv',index=False)
...
classifier=skflow.TensorFlowEstimator(model_fn=conv_model,n_classes=10,batch_size=2048,steps=20000,learning_rate=0.05)
classifier.fit(X_train,y_train)
...
conv_submission.to_csv('F:/demo/kaggle/mnist/conv_2048_005_submission.csv',index=False)
