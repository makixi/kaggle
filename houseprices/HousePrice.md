...
### Stacked Model
可以在基础模型上添加一个元模型，使用 out-of-folds 预测来训练元模型。<br>
<br>
训练部分的过程：<br>
1.将训练集分割成两个不相交的集合(train和holdout)<br>
2.在train上训练几个base models<br>
3.在holdout上测试这些base models<br>
4.用来自3的预测作为输入，正确的response作为输出来训练元模型。<br>
